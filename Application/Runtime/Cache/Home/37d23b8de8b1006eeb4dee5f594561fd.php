    ...
    <div class="p-submenu">
       ...
       <ul>
         ...
         <div class="col-lg-11s  col-md-12">
            <div class="clearfix art-lis-ind">
               <?php if(is_array($conts)): $i = 0; $__LIST__ = $conts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(!empty($vo['defaultpic'])): ?><div class="item-item">
                     <div class="row">
                        <div class="col-sm-5 img-area"><img src="<?php echo ($vo['defaultpic']); ?>" class="img-responsive"></div>
                        <div class="col-sm-7">
                           <a href="<?php echo ($vo['links']); ?>" class="t hit"><div class="hidden hitCount"><?php echo ($vo['id']); ?></div><?php echo ($vo['title']); ?></a>
                           <div class="clearfix cont"><?php echo ($vo['shortcontent']); ?></div>
                           <div class="clearfix d"><span><?php echo (substr($vo['addtime'],0,10)); ?></span></div>
                        </div>
                     </div>
                  </div>
                  <?php else: ?>
                  <div class="item-item">
                     <a href="<?php echo ($vo['links']); ?>" class="t hit"><div class="hidden hitCount"><?php echo ($vo['id']); ?></div><span><?php echo (substr($vo['addtime'],0,10)); ?></span><?php echo ($vo['title']); ?></a>
                     <div class="clearfix cont"><?php echo ($vo['shortcontent']); ?></div>
