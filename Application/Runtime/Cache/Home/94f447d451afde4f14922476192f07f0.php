    ...
    <div class="p-submenu">
       ...
       <ul>
         ...
         <div class="col-lg-11s  col-md-12">
            <div class="pm-box">
               <div class="p-t hidden-xs text-center"><?php echo ($cont['title']); ?></div>
               <div class="clearfix boxm">
                  <div class="clearfix text-center pad-v-md pad-h-xs visible-xs f-md"><?php echo ($cont['title']); ?></div>
                  <p class="text-center"><span>日期：<?php echo (substr($cont['addtime'],0,10)); ?></span>&nbsp;<span>阅读：<?php echo ($cont['hits']); ?></span><br /><br /></p>
                  <div class="clearfix gray"><?php echo ($cont['content']); ?></div>
               </div>
            </div>
         </div>
      </div>
