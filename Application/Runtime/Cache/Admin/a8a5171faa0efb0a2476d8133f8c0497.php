...
<div class="row">
   <div class="col-xs-12">
      <form name="import_form" method="post" onsubmit="return checkfm();" action="<?php echo U('/Content/update');?>">
      <div class="nav-tabs-custom">
         ...
         <div class="tab-content form-horizontal">            
            ...
            <div class="active tab-pane" id="default">
               <?php if(count($catelis) > 0): ?><div class="form-group">
                  ...
                  <div class="col-sm-2 col-xs-12">
                     <select name="cateid" id="cateid" class="form-control">                                 
                        <option value="<?php echo ($focusid); ?>" <?php if($rs['cateid'] == $focusid): ?>selected='selected'<?php endif; ?>><?php echo ($focusname); ?></option>
                        <?php if(is_array($catelis)): $i = 0; $__LIST__ = $catelis;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rscate): $mod = ($i % 2 );++$i;?><option value="<?php echo ($rscate['id']); ?>" <?php if($rs['cateid'] == $rscate['id']): ?>selected='selected'<?php endif; ?>><?php $__FOR_START_12763__=0;$__FOR_END_12763__=$rscate['level'];for($i=$__FOR_START_12763__;$i < $__FOR_END_12763__;$i+=1){ ?>∟<?php } echo ($rscate['catename']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                     </select>
                  </div>
               </div>
               <?php else: ?>
               ...
               <input type="hidden" name="doid" value="<?php echo ($rs['id']); ?>" />
               <div class="form-group">
                  <label for="title" class="col-sm-2 control-label">标题：</label>
                  <div class="col-sm-4 col-xs-12">
                     <input type="text" class="form-control" name="title" id="title" value="<?php echo ($rs['title']); ?>">
                  </div>
               </div>
               <div class="form-group">
                  <label for="tags" class="col-sm-2 control-label">标签：</label>
                  <div class="col-sm-4 col-xs-12">
                     <input type="text" class="form-control" name="tags" id="tags" value="<?php echo ($rs['tags']); ?>">
                  </div>
               </div>
               <div class="form-group">
               ...
               <!-- <div class="form-group">
                  ...
                  <div class="col-sm-4 col-xs-12">
                     <select class="form-control" name="sid" id="sid">
                        ...
                        <?php if(is_array($plis)): $i = 0; $__LIST__ = $plis;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rsp): $mod = ($i % 2 );++$i;?><option value="<?php echo ($rsp['id']); ?>" <?php if($rs['sid'] == $rsp['id']): ?>selected='selected'<?php endif; ?>><?php echo ($rsp['catename']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                     </select>
                  </div>
               </div> -->
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-3 col-xs-8">
                     <p><input type="text" class="form-control" name="poster-big" id="poster-big" value="<?php echo ($rs['poster-big']); ?>" /></p>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-3 col-xs-8">
                     <p><input type="text" class="form-control" name="poster-small" id="poster-small" value="<?php echo ($rs['poster-small']); ?>" /></p>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-4 col-xs-12">
                     <input type="text" class="form-control" name="playurl" id="playurl" value="<?php echo ($rs['playurl']); ?>">
                  </div>
               </div>
               -->
               <!-- <div class="form-group">
                  ...
                  <div class="col-sm-2 col-xs-12">
                     <input type="text" class="form-control" name="thebeg" id="thebeg" value="<?php echo ($rs['thebeg']); ?>">
                  </div>
               </div>
               <div class="form-group">
                  <label for="theed" class="col-sm-2 control-label">结束时间：</label>
                  <div class="col-sm-2 col-xs-12">
                     <input type="text" class="form-control" name="theed" id="theed" value="<?php echo ($rs['theed']); ?>">
                  </div>
               </div> -->
               <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10 col-xs-12">
                     <textarea class="kindeditor" style="width:100%; height:300px;" name="content"><?php echo (htmlspecialchars($rs['content'])); ?></textarea>
                  </div>
               </div>
               <div class="form-group">
                  <label for="author" class="col-sm-2 control-label">作者：</label>
                  <div class="col-sm-2 col-xs-12">
                     <input type="text" class="form-control" name="author" id="author" value="<?php echo ($rs['author']); ?>">
                  </div>
               </div>
               <div class="form-group">
                  <label for="comefrom" class="col-sm-2 control-label">来源：</label>
                  <div class="col-sm-1 col-xs-12">
                     <input type="text" class="form-control" name="comefrom" id="comefrom" value="<?php echo ($rs['comefrom']); ?>">
                  </div>
               </div>
               <div class="form-group">
                  <label for="hits" class="col-sm-2 control-label">点击率：</label>
                  <div class="col-sm-2 col-xs-12">
                     <input type="text" class="form-control" name="hits" id="hits" value="<?php echo ($rs['hits']); ?>">
                  </div>
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-1 col-xs-12">
                     <select name="isgood" id="isgood" class="form-control">
                        <option value="0" <?php if($rs['isgood'] == 0): ?>selected='selected'<?php endif; ?>>否</option>
                        <option value="1" <?php if($rs['isgood'] == 1): ?>selected='selected'<?php endif; ?>>是</option>
                     </select>
                  </div>
               </div>
               <div class="form-group">
                  ...
                  <div class="col-sm-1 col-xs-12">
                     <select name="isfocus" id="isfocus" class="form-control">
                        <option value="0" <?php if($rs['isfocus'] == 0): ?>selected='selected'<?php endif; ?>>否</option>
                        <option value="1" <?php if($rs['isfocus'] == 1): ?>selected='selected'<?php endif; ?>>是</option>
                     </select>
                  </div>
               </div>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-4 col-xs-12">
                     <input type="text" class="form-control" name="addtime" id="addtime" value="<?php echo ($rs['addtime']); ?>">
                  </div>
               </div>
               <div class="form-group">
            ...
            <div class="tab-pane" id="piclis">               
               ...
               <div class="form-group">
                  <div class="col-sm-10 col-sm-offset-1 col-xs-12 hidden-xs">
                     ...
                     <p><input type="hidden" name="picarr" id="picarr" value="<?php echo ($rs['picarr']); ?>"></p>
               ...
               <div class='form-group'>
                  <div class='col-sm-10 col-sm-offset-1 col-xs-12' id="picarrlist" style="padding-left:0;">
                     <?php if(is_array($vopiccm)): $i = 0; $__LIST__ = $vopiccm;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pic): $mod = ($i % 2 );++$i;?><div class='col-sm-2 col-xs-4'><p><img src='/<?php echo ($pic[pic]); ?>' class='img-responsive' /></p><p><input type='text' class='form-control text-center' name='picarrcm[]' value='<?php echo ($pic[piccm]); ?>' /></p><p class='text-center'><a href='javascript:void(0);' data-replace='<?php echo ($pic[pic]); ?>' onclick='delpicarr(this)'><i class='fa fa-trash text-red'></i></a></p></div><?php endforeach; endif; else: echo "" ;endif; ?>
                  </div>   
               </div>               
            </div>             
