        ...
        <div class="col-xs-12">
          <div class="box box-danger">
            <div class="box-header with-border">                
                <a class="btn btn-info btn-sm" href="<?php echo U('/Carousel/add');?>"><i class="fa fa-plus"></i> 添加幻灯</a>
                 ...
                 <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                       <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?><tr>
                          ...
                          <td class="text-center"><img src="<?php echo ($rs['pic']); ?>" width="120" /></td>
                          <td><?php echo ($rs['links']); ?></td>
                          <td class="text-center">
                             <a class="btn btn-xs btn-info" href="<?php echo U('/Carousel/edit',array('id'=>$rs['id']));?>">
...
$(function(){
   ...
   $('.btn-sub-taxis').click(function(){
	  ...
	  $.ajax({
			 url: "<?php echo U('/Role/updatetaxis',array('tabel'=>'carousel'));?>", 
			 type: "POST",
...
function del(idarr){
      $.ajax({
			 url: "<?php echo U('/Carousel/delads');?>", 
			 type: "POST",
			 data:{'idarr':idarr}, 
			 success: function(d){
