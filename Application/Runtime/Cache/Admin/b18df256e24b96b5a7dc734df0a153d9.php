...
<div class="row">
   <div class="col-xs-12">
      <form name="import_form" method="post" action="<?php echo U('/Content/updatepage');?>">
      <div class="nav-tabs-custom">
         <ul class="nav nav-tabs">           
            <li class="active"><a href="#remark" class="remarkTab" data-toggle="tab"><?php echo ($rs['catename']); ?></a></li> 
         </ul>         
